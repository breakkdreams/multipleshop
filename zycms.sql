...
-- 数据库: `multipleshop`
--
CREATE DATABASE IF NOT EXISTS `multipleshop` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `multipleshop`;
...
(1, 'phpcms', '088fcd50285122e0cde598052dbdd1df', 1, 'mawGSA', '', 1495264309, 'yldets@126.com', '', '', '');
...
(1, 1, 0, 1, 'PHPCMS', 'http://www.phpcms.cn', 'http://www.phpcms.cn/images/logo_88_31.gif', '', '', 0, 0, 1, 1495264293),
(2, 1, 0, 1, '盛大在线', 'http://www.sdo.com', 'http://www.snda.com/cn/logo/comp_logo_sdo.gif', '', '', 0, 0, 1, 1495264293);
...
(1, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '', '2017-05-20 15:11:40'),
(2, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '', '2017-05-20 15:11:49');
...
('announce', '公告', 'announce/', 0, '1.0', '公告', '', 0, 0, '2017-05-20', '2017-05-20'),
('comment', '评论', 'comment/', 0, '1.0', '评论', '', 0, 0, '2017-05-20', '2017-05-20'),
('link', '友情链接', '', 0, '1.0', '', 'array (\n  1 => \n  array (\n    ''is_post'' => ''1'',\n    ''enablecheckcode'' => ''0'',\n  ),\n)', 0, 0, '2010-09-06', '2010-09-06'),
('vote', '投票', '', 0, '1.0', '', 'array (\r\n  1 => \r\n  array (\r\n    ''default_style'' => ''default'',\r\n    ''vote_tp_template'' => ''vote_tp'',\r\n    ''allowguest'' => ''1'',\r\n    ''enabled'' => ''1'',\r\n    ''interval'' => ''1'',\r\n    ''credit'' => ''1'',\r\n  ),\r\n)', 0, 0, '2010-09-06', '2010-09-06'),
('message', '短消息', '', 0, '1.0', '', '', 0, 0, '2010-09-06', '2010-09-06'),
('mood', '新闻心情', 'mood/', 0, '1.0', '新闻心情', '', 0, 0, '2017-05-20', '2017-05-20'),
('poster', '广告模块', 'poster/', 0, '1.0', '广告模块', '', 0, 0, '2017-05-20', '2017-05-20'),
('formguide', '表单向导', 'formguide/', 0, '1.0', 'formguide', 'array (\n  ''allowmultisubmit'' => ''1'',\n  ''interval'' => ''30'',\n  ''allowunreg'' => ''0'',\n  ''mailmessage'' => ''用户向我们提交了表单数据，赶快去看看吧。'',\n)', 0, 0, '2010-10-20', '2010-10-20'),
('wap', '手机门户', 'wap/', 0, '1.0', '手机门户', '', 0, 0, '2017-05-20', '2017-05-20'),
('upgrade', '在线升级', '', 0, '1.0', '', '', 0, 0, '2011-05-18', '2011-05-18'),
('tag', '标签向导', 'tag/', 0, '1.0', '标签向导', '', 0, 0, '2017-05-20', '2017-05-20'),
...
--
-- 表的结构 `zy_poster_201603`
--

CREATE TABLE IF NOT EXISTS `zy_poster_201603` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `spaceid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
('vqcohco790r2pvk2kmvm06m847', 1, '', 1495264439, 1, 0, 'admin', 'index', 'public_menu_left', 'code|s:0:"";userid|s:1:"1";roleid|s:1:"1";pc_hash|s:6:"iSvQIS";lock_screen|i:0;');
...
(1, '默认站点', '', 'http://localhost/zycms9.6.3/', 'PHPCMS演示站', 'PHPCMS演示站', 'PHPCMS演示站', '', 'default', 'default', 'array (\n  ''upload_maxsize'' => ''2048'',\n  ''upload_allowext'' => ''jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf'',\n  ''watermark_enable'' => ''1'',\n  ''watermark_minwidth'' => ''300'',\n  ''watermark_minheight'' => ''300'',\n  ''watermark_img'' => ''/statics/images/water/mark.png'',\n  ''watermark_pct'' => ''85'',\n  ''watermark_quality'' => ''80'',\n  ''watermark_pos'' => ''9'',\n)', '980c65dd-3d2b-11e7-8fef-9c5c8e7bb5ef');
...
(1, 'phpcms', '0e956595d4fee9f11ce669d90c5d0d9e', 'gDuyiw', 1, 0, '');
...
(1, 'phpcms_v9', 'phpcms v9', 'http://localhost/zycms9.6.3/', 'waYgbkwnSSFmgfkgGsfhQFdi0CSqCFKg', '', 'api.php?op=phpsso', 'utf-8', 1);
